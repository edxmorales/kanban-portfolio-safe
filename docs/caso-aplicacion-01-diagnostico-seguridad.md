...
La sección 0.1 de `FRAMEWORK.md` es explícita en que el frente 4 está "fuera de alcance por completo" del Diagnóstico 360 de **KPS** (los cinco ángulos de la sección 0, enfocados en flujo de trabajo y portafolio, no en infraestructura). Este caso es justamente un ejemplo de por qué esa distinción importa en la práctica: el equipo necesitó completar este frente de seguridad, con su propia disciplina, **antes** de que KPS entrara a operar la capa de flujo de trabajo — y lo que ese frente reveló terminó alimentando directamente el primer backlog del piloto KPS (ver [Propuesta de piloto 1](./propuesta-piloto-01.md)).
